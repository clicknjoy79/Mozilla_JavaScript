...
console.log(blob);
function QueryableWorker(blob, defaultListener, onError) {
    var instance = this;
    worker = new Worker(window.URL.createObjectURL(blob));   // like private property
...
var myTask = new QueryableWorker(blob);
